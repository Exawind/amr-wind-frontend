...
![amrwind_frontend_startup.png](images/amrwind_frontend_startup.png)
...
In the **Simulation type** list, choose both `FreeStream` and `Acutator`.

Under **Time control**, set **Max time** to `100.0` and **dt** to `0.1`:  

![](images/simulation_type_timecontrol.png)
...
![](images/simulation_propertiesvalues.png)
...
- **Domain corner 1**: `-1000.0 -500.0 -500.0`
- **Domain corner 2**: `1000.0  500.0 500.0`
- **Mesh size**: `128 64 64`

![](images/domain_domainmesh.png)
...
![](images/plotdomain_domain_level0.png)
...
![](images/turbines_addturbine.png)

Then under **Add turbines here**, click the **New** button.  

In the name field, add `turbine0` (this can be arbitrary.) Then 
select `NREL5MW ADM NOSERVERO` under **Use turbine type** and hit **Load**.

![](images/turbines_newturbine.png)
...
![](images/turbines_newturb_filledout.png)

Then hit the **[Save & Update FAST]** button at the top to make sure all OpenFAST parameters are consistent.
...
set **Max refinement level** to `1` to add one level of refinement.

![](images/refinement_maxlevel1.png)
...
Set the **Output freq** to `100`, and choose `velocity` as the
variable to plot.  Then press **[New]** to create a new sampling probe
input.

![](images/io_sampling.png)
...
![](images/plotdomain_basicfilled.png)
...
![](images/plotdomain_selected_box1turbine0.png)
...
![](images/plotdomain_domain_xyplane.png)
